...
export const metadata = {
  title: "About Us | DeWiN Solutions",
  description: "Learn about DeWiN Solutions and our mission to provide enterprise-grade cloud hosting solutions.",
};
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 py-20 md:py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              About{" "}
              <span className="text-[#FF6B6B]">DeWiN Solutions</span>
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <div className="w-16 h-16 rounded-2xl bg-[#1E2260] flex items-center justify-center mb-6">
                ...
                <div key={index} className={`flex items-center gap-8 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className="flex-1 text-right md:text-left">
                    <div className={`${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                      <span className="inline-block px-4 py-1 rounded-full bg-[#1E2260]/10 text-[#1E2260] font-semibold mb-2">
                        {item.year}
                      </span>
                  ...
                  <div className="w-4 h-4 rounded-full bg-[#1E2260] border-4 border-white shadow-lg z-10 flex-shrink-0"></div>
            ...
            {team.map((member, index) => (
              <Card key={index} className="border-0 shadow-lg">
                <CardContent className="p-6 text-center">
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#1E2260] to-[#4A9FD5] flex items-center justify-center">
                    <Users className="h-12 w-12 text-white" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">
                    {member.name}
                  </h3>
                  <p className="text-[#1E2260] font-medium mb-3">{member.role}</p>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-[#1E2260] flex items-center justify-center">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">info@dewin.com</p>
                <p className="text-gray-600">sales@dewin.com</p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
      ...
      <section className="py-20 bg-gradient-to-r from-[#1E2260] to-[#4A9FD5]">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses who trust DeWiN for their cloud hosting needs.
          </p>
